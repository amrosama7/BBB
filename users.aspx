      ...
      <div class="top-bar background-white">
       ...
       <%--   <div class="s-12 m-6 l-6">
          ...
          <div class="s-8 m-4 l-4 floatRight">
            <div class="right">
                <asp:Button ID="Button6" CssClass="right signout pointer" runat="server" OnClick="Button1_Click" Text="SignOut" />
                <asp:Button ID="Button5" CssClass="right signout pointer" runat="server" OnClick="Button1_Click" Text="Account" />
            </div>
          </div>
        </div>
      </div>
