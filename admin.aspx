         ...
         <div class="position-relative height65 priv">
                <div class="flex spaceBetween">
                    <div class="inlineBlock position-relative">
                        <input id="search" class="reset-this abbc width15" type="text" placeholder="Search"/>
                        <button type="button" class="reset-thispointer absolute" style="color: black; background-color: transparent;" id="searchBtn" ><i class="fa fa-search marginTop10 green" aria-hidden="true"></i></button>
                    </div>
        
                    <%--<div class="inlineBlock">Users</div>
                    <div class="inlineBlock">Orders</div>
                    <div id="code" class="inlineBlock">Add code</div>
                    <div id="password" class="inlineBlock">Change Password</div>--%>
                    <div class="newOrderBtn inlineBlock width15">Users</div>
                    <div class="newOrderBtn inlineBlock width15">Orders</div>
                    <div id="code" class="newOrderBtn inlineBlock width15">Add code</div>
