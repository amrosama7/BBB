...
<body class="loginBody size-1140">
    ...
    <div class="signBox">
        ...
        <div class="">
            ...
            <asp:TextBox ID="TextBox1" TabIndex="1" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox2" class="display-block font14 marginBottom5 marginTop5">Password</label>
            <asp:TextBox ID="TextBox2" TabIndex="2" type="password" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
