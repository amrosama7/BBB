    ...
    <main role="main">
      <!-- Main Carousel -->
        ...
        <div class="typewriter">
            <h1>Welcome to LoadBugs.</h1>
        </div>
        <div class="s-12 center ship">
            <img class="position-relative left20 shipping inlineBlock" src="img/shipping.gif" alt=""/> 
            <img class="position-relative left20 shipping2 inlineBlock" src="img/shipping.gif" alt=""/>     
        </div>
