...
<body class="loginBody size-1140">
    ...
    <div class="signBox width40p marginBottom20">
        ...
        <div class="">
            ...
            <asp:TextBox ID="TextBox4" TabIndex="1" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
              <label for="TextBox9" class="display-block font14 marginBottom5 marginTop5">Initials maximum 4 characters</label>
            <asp:TextBox ID="TextBox9" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>


            <label for="TextBox8" class="display-block font14 marginBottom5 marginTop5">Company Name</label>
            <asp:TextBox ID="TextBox8" TabIndex="2" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox5" class="display-block font14 marginBottom5 marginTop5">Email</label>
            <asp:TextBox ID="TextBox5" type="email" TabIndex="3" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox6" class="display-block font14 marginBottom5 marginTop5">Address</label>
            <asp:TextBox ID="TextBox6" TabIndex="4" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox7" class="display-block font14 marginBottom5 marginTop5">Phone Number</label>
            <asp:TextBox ID="TextBox7" type ="number" TabIndex="5" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox1" class="display-block font14 marginBottom5 marginTop5">User Name</label>
            <asp:TextBox ID="TextBox1" TabIndex="6" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox2" class="display-block font14 marginBottom5 marginTop5">Password</label>
            <asp:TextBox ID="TextBox2"  TabIndex="7" type ="password" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
            <label for="TextBox3" class="display-block font14 marginBottom5 marginTop5">Confirm Password</label>
            <asp:TextBox ID="TextBox3" TabIndex="8" type="password" runat="server" class="display-block marginBottom15 width100 input"></asp:TextBox>
