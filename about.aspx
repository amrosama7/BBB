  ...
  <a href="" class="logo"><img src="img1/loggg.png" alt=""></a>             
          ...
          <div class="top-nav s-12 l-10">
            ...
            <ul class="right chevron">
              ...
              <li><a href="about.aspx" class="marginLeft2 active">About</a></li>
    ...
    <main role="main">
      ...
      <article>
        <div class="section background-white"> 
          <div class="line">
            <h2 class="text-size-30 center marginBottom15">About Loadbugs</h2>
            <p>
           Now you can safely say your goodbyes to lengthy delivery processes and say hello to LoadBugs!
                 We are a courier company that takes prides in our core values which are efficiency and safety.
            </p>
              <br />
              <br />
              <br />
              <h2 class="text-size-30 center marginBottom15">B2B and Small Business Services</h2>
              <p>
                  This is where we come in, our job is to take your parcels and have them delivered the next business day, consequent to receiving your order request that you upload to our website using your personal account.
                   Upon receiving your order, we will call you for the pick up, and deliver the parcel the next business day to your client.
                   Our efficient bugs are everywhere and they are just patiently waiting to be loaded.
                   Loadbugs can help you to maintain your high-quality service standards by delivering your products on time, which will lead to satisfied customers.
                   We offer cash collection service for our clients.
                   This includes setting up a private account for you, which will be managed by our sales department, where the cash is delivered directly to you or deposited to your bank account.
                   This will be laid out in a contract between you and Loadbugs.
With a clear line of communication between Loadbugs and our customers we guarantee satisfaction.
              ...
              <br />
              <br />
              <h2 class="text-size-30 center marginBottom15">Track your orders</h2>
              <p>
                  Loadbugs’s online tracking system will give you the capability to track your orders online giving you 24/7 access to information regarding your shipments.
                   This allows you to simply keep track of your package every step of the way.
              </p>
